...
public class StudentConfig {
    ...
    CommandLineRunner commandLineRunner(StudentRepository repository) {
        return args -> {
            ...
            Student joe = new Student("Joe", "joegung77@yahoo.com", LocalDate.of(2002, Month.JANUARY, 21));
            Student wendy = new Student("Wendy", "wendygong@gmail.com", LocalDate.of(2012, Month.JANUARY, 1));
